  ...
  render() {
    ...
    return (
      <div className='MobileCompany'>
        ...
        <div>
          <button className='MobileCompanyFilter_btn AllBtn' value='all' 
          onClick={this.showAllClients}
          >Все</button>
          <button className='MobileCompanyFilter_btn ActiveBtn' value='active' 
          onClick={this.showActiveClients}
          >Активные</button>
          <button className='MobileCompanyFilter_btn BlockedBtn' value='blocked' 
        ...
        </table>
        {
          ...
          ?
          <button className='MobileCompanyNewClient_btn AddNewClientBtn' value='add' onClick={this.showAddClientCard}>
            Добавить клиента
          </button>
          :
          <AddOrEditClient 
